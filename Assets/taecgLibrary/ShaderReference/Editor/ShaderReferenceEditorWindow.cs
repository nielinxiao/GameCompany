...
namespace taecg.tools.shaderReference
{
    public class ShaderReferenceEditorWindow : EditorWindow
    {
        ...
        private string[] tabNames = new string[] { "GPU", "Pipline", "Properties", "Semantics", "Tags", "Render State", "Compile Directives", "Transformations", "Other", "BuildIn Variables", "Predefined Macros", "Platform Differences", "Math", "Lighting", "Miscellaneous", "Error Debug", "GLSL", "Setup", "About" };
        ...
        private ShaderReferenceBuildInTransformation transformation;
        ...
        void OnEnable()
        {
            ...
            transformation = ScriptableObject.CreateInstance<ShaderReferenceBuildInTransformation>();
